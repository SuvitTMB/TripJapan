...
$(document).ready(function () {
  ...
  str += '<div class="NameLine" style="font-size:12px;">66'+ sessionStorage.getItem("LineName")+'</div>';
  $("#MyProfile").html(str);  
  Connect_DB();
*/
...
async function main() {
  await liff.init({ liffId: "1655966947-2mRZBV8n" });
...
async function getUserProfile() {
  ...
  str += '<div class="NameLine" style="font-size:12px;">'+ sessionStorage.getItem("LineName")+'</div>';
  $("#MyProfile").html(str);  
  Connect_DB();
  //CheckData();
}
